...
The dashboard below brings together the main evidence from the project in one view: model development, personalized feature experiments, subject-wise detection, the final confusion matrix, ROC performance, and final evaluation metrics.
